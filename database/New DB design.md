...
| :------- | ---- | ------- | ---- |
| TimeUUID | TEXT | SET    | BLOB |

### Messages

| UUID     | Channel  | Message | Username |
| :------- | -------- | ------- | -------- |
| TimeUUID | TimeUUID | Text    | Text     |
...
### Create channel
The list of members goes as follows:
 - Empty: Everyone is in
 - Contains lowercase usernames: Only the usernames are in
```sql
...
Channels >> List containing all the channels the user is member of. The channels are defined by their UUID

They'll always at least be members of `GLOBAL`

```sql
INSERT INTO Users (user_low, username, passwordhash, channels) values('theperkinrex', 'ThePerkinrex', 'hduaig7w8w3hienw7f830hcnspiao8ye8w3', {ab444690-50b2-11e9-be62-8165917cc8f6});
```
